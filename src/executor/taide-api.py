...
class TaideApiExecutor(LLMExecutor):

    api_key: str = "YOUR_TAIDE_API_KEY_HERE"
    model_name: str = "TAIDE/a.2.0.0-SG"
    openai_base_url: str = "https://td.nchc.org.tw/api/v1/"
    ...
    def extend_arguments(self, parser):
        ...
        model_group.add_argument('--api_key', default=self.api_key, help='The API key to access the service')
    ...
    async def llm_compute(self, data):
        try:
            openai_token = self.args.api_key
            ...
            response = await client.chat.completions.create(
                ...
                messages=msg,
                stream=True, # TAIDE streaming API doesn't follow proper JSON format (Use ' instead of ")
