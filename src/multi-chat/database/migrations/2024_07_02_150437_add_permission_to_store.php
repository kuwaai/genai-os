...
return new class extends Migration
{
    ...
    public function up(): void
    {
		...
		$permissions = [
			'Store_read_discover_group_bots'
		];
		...
		$spec_perm_id = Permissions::where("name","=","Store_read_discover_my_bots")->first()->id;
		...
		$oldPermission = Permissions::where('name', 'Store_read_discover_my_bots')->first();
		if ($oldPermission) {
			$oldPermission->name = 'Store_read_discover_private_bots';
