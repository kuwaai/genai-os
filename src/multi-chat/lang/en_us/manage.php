...
return [
    ...
    'placeholder.group_detail' => 'Group Annotation',
    'label.read' => 'Read',
    'label.delete' => 'Delete',
    'label.update' => 'Update',
    'label.create' => 'Create',
    ...
    'label.other_users' => 'Non-group members',
    ...
    'placeholder.description' => 'A description of this model',
    'label.version' => 'Version',
    'label.access_code' => 'Access Code',
    'placeholder.link' => 'An external link related to this model',
    ...
    'modal.confirm_setting_modal.shrink_max_upload_file_count' => 'Lowering the total upload file limit will delete user files exceeding the limit. Are you sure?',
    ...
    'label.reloginWarning' => 'You will need to log in again after the website is updated. All Workers will restart. Are you sure you want to update the website?',
    ...
    'label.upload_allowed_extensions' => 'Allowed Upload Extensions (* for any extension)',
    'label.upload_max_file_count' => 'Total Upload File Limit (-1 for no limit)',

    //kernel
    'label.kernel_location' => 'Kernel Connection Location',
    'label.safety_guard_API' => 'Safety Guard Connection Location',
    'label.ready' => 'Ready',
    'label.busy' => 'Busy',
