...
return [
    ...
    'label.fuzzy_search' => 'Rechercher les utilisateurs par nom ou par adresse e-mail',
    ...
    'label.require_change_password' => 'Demander de modifier le mot de passe à la prochaine connexion',
    ...
    'label.reloginWarning' => 'La mise à jour du site Web redémarrera temporairement tous les Worker et redémarrera 10 Worker une fois la mise à jour terminée. Êtes-vous sûr de vouloir commencer la mise à jour ?',
    ...
    'hint.smtp_not_configured' => 'Aucun mode de connexion SMTP configuré ! La fonction de vérification de la boîte aux lettres ne sera pas activée',
