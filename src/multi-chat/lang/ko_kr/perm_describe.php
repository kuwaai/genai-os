...
return [
    ...
    'Room_update_detail_feedback' => '답변에 대한 자세한 피드백 태그를 제공할 권한',
    'Room_read_access_to_api' => '웹사이트 API를 사용할 권한',
    'Room_update_send_message' => '대화에서 메시지를 보낼 권한 (대화 생성에는 영향을 미치지 않음)',
    'Room_update_new_chat' => '대화를 생성할 권한',
    'Room_update_feedback' => '모델 사용 피드백을 제출할 권한',
    ...
    'Room_update_react_message' => '메시지에 대한 추가 작업 버튼(예: 인용, 번역 등)을 사용할 권한',
    'Room_update_ignore_upload_constraint' => '시스템 설정에 있는 모든 파일 업로드 제한을 무시하고 임의의 파일을 업로드할 수 있는 권한',
    'Dashboard_read_statistics' => '통계 정보에 접근할 권한',
    'Dashboard_read_blacklist' => '블랙리스트에 접근할 권한',
    'Dashboard_read_feedbacks' => '피드백 데이터에 접근할 권한',
    'Dashboard_read_logs' => '시스템 로그에 접근할 권한',
    'Dashboard_read_safetyguard' => '보안 필터에 접근할 권한',
    'Dashboard_read_inspect' => '메시지 브라우저에 접근할 권한',
    ...
    'Store_read_discover_community_bots' => '커뮤니티 봇을 찾아보는 데 필요한 권한',
    'Store_read_discover_system_bots' => '시스템 봇을 찾아보는 데 필요한 권한',
    'Store_read_discover_private_bots' => '자체 제작 봇을 찾아보는 데 필요한 권한',
    'Store_read_discover_group_bots' => '그룹 봇을 찾아보는 데 필요한 권한',
