...
return [
    ...
    'placeholder.PasteRawDataHere' => '변환할 원시 데이터를 붙여넣거나, 파일을 드래그 앤 드롭 하세요.',
    ...
    "hint.wip_option"=>"작업 중입니다. 현재 옵션은 없습니다.",
