...
return [
    ...
    'header.confirmUpdate' => '웹사이트를 업데이트하시겠습니까?',
    'label.reloginWarning' => '웹사이트 업데이트 후 다시 로그인해야 합니다. 모든 작업 처리기가 다시 시작됩니다. 웹사이트를 업데이트하시겠습니까?',
    'label.settings' => '웹사이트에 대한 모든 설정을 여기에서 조정할 수 있습니다.',
    ...
    //Workers
    'label.failed' => '작업 실패. 다시 시도해 주십시오.',
    'label.loading' => '로드 중...',
