...
return [
    ...
    'label.other_users' => '그룹에 속하지 않은 사용자',
    'button.return_group_list' => '그룹 목록으로 돌아가기',
    'placeholder.search_user' => '이메일 또는 이름을 검색합니다.',
    ...
    'label.reloginWarning' => '웹사이트 업데이트는 모든 Worker를 일시적으로 다시 시작하고 업데이트가 완료된 후 10개의 Worker를 다시 시작합니다. 업데이트를 시작하시겠습니까?',
    'label.settings' => '웹사이트에 대한 모든 설정을 여기서 조정할 수 있습니다.',
    'label.allow_register' => '등록 허용',
    'button.reset_redis' => 'Redis 캐시 재설정',
    'hint.saved' => '저장되었습니다.',
    'hint.smtp_not_configured' => 'SMTP 연결 방식이 설정되지 않았습니다! 이메일 인증 기능은 활성화되지 않습니다.',
