...
return [
    ...
    'label.require_change_password' => '다음 로그인 시 비밀번호 변경 요청',
    ...
    //setting
    'header.settings' => '웹사이트 설정',
    'header.updateWeb' => '웹사이트 업데이트 진행률',
    'header.confirmUpdate' => '웹사이트 업데이트를 진행하시겠습니까?',
    'label.reloginWarning' => '웹사이트 업데이트 후 다시 로그인해야 하며 모든 Worker가 재시작됩니다. 웹사이트를 업데이트하시겠습니까?',
    ...
    'label.safety_guard_API' => '안전 보호 연결 위치',
    'label.ready' => '준비됨',
    'label.busy' => '바쁨',
    ...
    'label.error' => '오류',
    'label.valid_worker_count' => '올바른 작업 처리기 수를 입력하세요.',
