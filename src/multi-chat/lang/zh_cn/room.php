...
return [
    ...
    'modal.label' => '请选择您想要同时使用的模型',
    'button.create' => '创建',
    'hint.must_select_llms' => '您必须选择至少一个模型！',
    'button.edit_chatname' => '编辑聊天室名称',
    'button.share_link' => '分享链接',
    'label.share_link' => '分享链接 (目前只有自己可访问)',
    'model.hint' => '请选择您想使用的模型：',
    'connecting.hint' => '- 连接中 -',
    'connected.hint' => '连接成功',
    'button.sort_by' => '排序方式',
    'sort_by.date' => '按日期排序',
