...
return [
    ...
    'header.create_model' => '创建模型档案',
    'modal.create_model.header' => '您确定要创建这个档案？',
    ...
    'header.update_model' => '编辑模型档案',
    'label.description' => '叙述',
    'modal.update_model.header' => '您确定要更新这个语言模型档案吗',
    'modal.delete_model.header' => '您确定要删除这个语言模型档案吗',
    ...
    'label.reloginWarning' => '网站更新后将会需要重新登录，所有Worker都将重启，确定要更新该网站吗',
