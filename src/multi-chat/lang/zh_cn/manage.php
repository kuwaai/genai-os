...
return [
    ...
    'modal.confirm_setting_modal.shrink_max_upload_file_count' => '降低上传文件总数量限制会删除超出的用户文件，您确定吗?',
    ...
    'label.upload_max_file_count' => '上传文件总数量限制 (-1 表示不限制数量)',
];