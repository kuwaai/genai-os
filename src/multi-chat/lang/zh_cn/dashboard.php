...
return [
    ...
    'filter.EndDate' => '结束：',
    'filter.Action' => '操作：',
    'filter.Description' => '描述：',
    'filter.UserID' => '操作者ID：',
    'filter.IPAddress' => 'IP位置：',

    'placeholder.PasteRawDataHere' => '请粘贴要转换的原始数据，也可以将文件拖移至此。',
