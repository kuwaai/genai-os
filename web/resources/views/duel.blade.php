<x-app-layout>
    ...
    <div class="flex h-full max-w-7xl mx-auto py-2">
        <div class="bg-white dark:bg-gray-800 text-white w-64 flex-shrink-0 relative rounded-l-lg overflow-hidden">
            <div
                class="p-3 {{ request()->route('duel_id') || session('llms') ? 'flex flex-col' : '' }} h-full overflow-y-auto scrollbar">
                @if ($result->count() == 0)
                    <div
                ...
                <div id="delete_chat_modal" tabindex="-1"
                    ...
                    <div class="relative w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <form id="deleteChat" action="{{ route('duel.delete') }}" method="post"
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                    {{ __('Are you sure you want to DELETE the chat ') }}"<span>{{ App\Models\DuelChat::findOrFail(request()->route('duel_id'))->name }}</span>"?
                                </h3>
                                @csrf
                                @method('delete')
