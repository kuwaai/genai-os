<div id="delete_chat_modal" tabindex="-1"
    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form id="deleteChat" action="{{ route('chat.delete') }}" method="post" class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    {{ __('chat.modal.delete_chat.header') }}"<span>{{ App\Models\Chats::findOrFail(request()->route('chat_id'))->name }}</span>"?
                </h3>
                @csrf
                @method('delete')
