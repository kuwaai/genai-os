...
<div class="flex space-x-1{{ $showOnFinished ? ' show-on-finished' : '' }}"
    ...
    <button class="flex text-black hover:bg-gray-400 p-2 rounded-lg" data-tooltip-target="react_copy"
        data-tooltip-placement="top" onclick="copytext($(this).parent().parent().children()[0])">
    ...
    <button data-tooltip-target="react_translate" data-tooltip-placement="top"
        ...
        <svg width="15" height="16" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" version="1.0">
