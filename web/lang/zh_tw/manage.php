...
return [
    ...
    //Permissions
    'perm.Room_update_import_chat' => '匯入聊天室',
    'perm.Room_update_new_chat' => '創建新聊天室',
    'perm.Room_update_feedback' => '給予回饋',
    'perm.Room_update_send_message' => '傳送訊息',
    'perm.Room_update_react_message' => '額外操作按鈕',
    'perm.Room_read_export_chat' => '匯出聊天室',
    'perm.Room_delete_chatroom' => '刪除聊天室',
    ...
    'perm.Chat_update_new_chat' => '創建新聊天室',
    'perm.Chat_update_upload_file' => '上傳檔案',
    'perm.Chat_update_feedback' => '給予回饋',
    'perm.Chat_update_import_chat' => '匯入聊天室',
    'perm.Chat_read_access_to_api' => '使用網站API',
    'perm.Chat_read_export_chat' => '匯出聊天室',
    'perm.Chat_delete_chatroom' => '刪除聊天室',
    ...
    'perm.Chat_read_access_to_api.describe' => '使用網站API的權限',
    'perm.Chat_update_send_message.describe' => '在聊天室中送出訊息的權限（不影響創建）',
    'perm.Room_update_send_message.describe' => '在聊天室中送出訊息的權限（不影響創建）',
    'perm.Chat_update_new_chat.describe' => '創建聊天室的權限',
    'perm.Room_update_new_chat.describe' => '創建聊天室的權限',
    'perm.Chat_update_upload_file.describe' => '上傳檔案的權限(仍需要創建聊天室的權限才能使用)',
    'perm.Chat_update_feedback.describe' => '送出模型使用回饋的權限',
    'perm.Room_update_feedback.describe' => '送出模型使用回饋的權限',
    'perm.Room_delete_chatroom.describe' => '刪除聊天室的權限',
    'perm.Chat_delete_chatroom.describe' => '刪除聊天室的權限',
    'perm.Chat_read_export_chat.describe' => '匯出聊天紀錄的權限',
    'perm.Room_read_export_chat.describe' => '匯出聊天紀錄的權限',
    'perm.Chat_update_import_chat.describe' => '匯入聊天室紀錄的權限（仍需要創建聊天室的權限）',
    'perm.Room_update_import_chat.describe' => '匯入聊天室紀錄的權限（仍需要創建聊天室的權限）',
