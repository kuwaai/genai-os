...
return [
    ...
    'perm.Room_update_new_chat' => '建立新聊天室',
    ...
    'perm.Chat_update_new_chat' => '建立新聊天室',
    ...
    'perm.Chat_update_send_message.describe' => '在聊天室中送出訊息的權限（不影響建立）',
    'perm.Room_update_send_message.describe' => '在聊天室中送出訊息的權限（不影響建立）',
    'perm.Chat_update_new_chat.describe' => '建立聊天室的權限',
    'perm.Room_update_new_chat.describe' => '建立聊天室的權限',
    'perm.Chat_update_upload_file.describe' => '上傳檔案的權限(仍需要建立聊天室的權限才能使用)',
    ...
    'perm.Chat_update_import_chat.describe' => '匯入聊天室紀錄的權限（仍需要建立聊天室的權限）',
    'perm.Room_update_import_chat.describe' => '匯入聊天室紀錄的權限（仍需要建立聊天室的權限）',
