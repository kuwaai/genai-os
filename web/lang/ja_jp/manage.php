...
return [
    ...
    'perm.Profile_update_openai_token' => 'OpenAIキーの変更',
    'perm.Profile_read_api_token' => 'ウェブサイトAPIキーの表示',
    'perm.Profile_delete_account' => 'アカウントの削除',

    'perm.Chat_update_detail_feedback.describe' => '詳細フィードバックを提供する権限',
    'perm.Room_update_detail_feedback.describe' => '詳細フィードバックを提供する権限',
    'perm.Profile_update_api_token.describe' => 'ウェブサイトAPIキーの更新権限',
    'perm.Profile_update_name.describe' => '自分のアカウント名を変更する権限',
    'perm.Profile_update_email.describe' => '自分のメールアドレスを変更する権限',
    'perm.Profile_update_password.describe' => '自分のパスワードを変更する権限',
    'perm.Profile_update_openai_token.describe' => 'ウェブサイト上のOpenAIキーを更新する権限',
