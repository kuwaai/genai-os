...
LLM_name = "TAIDE LLaMA2 7b b1.0.0 Test"
...
def api():
    ...
    return ""
registered = True
response = requests.post(agent_endpoint + "register", data={"version":version_code,"name":LLM_name,"endpoint":"http://{0}:{1}/".format(public_ip, port)})
