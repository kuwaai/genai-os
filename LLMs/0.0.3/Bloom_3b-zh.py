...
if not dummy:
    ...
    model = BloomForCausalLM.from_pretrained("ckip-joint/bloom-3b-zh", device_map="auto")
    tokenizer = BloomTokenizerFast.from_pretrained("ckip-joint/bloom-3b-zh")
