...
if not dummy:
    ...
    model = LlamaForCausalLM.from_pretrained("llama-7b_sft-v5-s6251", device_map="auto",torch_dtype=torch.float16)
    ...
    def process(data):
        ...
        while checker and len(records) < 600:
            ...
            outputs = model.generate(
                inputs.cuda(), max_new_tokens=1, generation_config=
                GenerationConfig(
