...
fix() {
        cd executor
        echo "llama-cpp-python @ https://github.com/abetlen/llama-cpp-python/releases/download/v0.2.87/llama_cpp_python-0.2.87-cp310-cp310-linux_aarch64.whl" > requirements.txt
        cd ../../src/executor
