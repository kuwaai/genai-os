...
return [
     ...
     //Tab_feedback
     'hint.PasteRawDataHere' => '请贴上要转换的原始资料，也可以将档案拖移至此。 ',
     "hint.wip_option"=>"待完成，目前暂无选项",
     'header.ActiveModels' => '已启用模型',
     'header.InactiveModels' => '已停用模型',
     'header.ModelFilter' => '过滤模型：',
     'header.ExportSetting' => '汇出设定：',

     'button.ExportAndDownload' => '汇出并下载',
     'button.LoadFile' => '载入档案',
     'button.ConvertAndDownload' => '转换并下载',
     'msg.MustHave1Model' => '你必须选取至少一个模型来汇出',
