...
if exist "%pip_exe%" (
	...
	%pip_exe% install --default-timeout=1000 https://www.piwheels.org/simple/docopt/docopt-0.6.2-py2.py3-none-any.whl#sha256=15fde8252aa9f2804171014d50d069ffbf42c7a50b7d74bcbb82bfd5700fcfc2
