...
if "!TARGET!"=="" (
    echo Please drag the database or the archive of database to this script.
    pause
    exit 1
)
...
if not "!valid_database!" == "T" (
    echo !original_target! is not a valid database. Abort importing.
    pause
    exit 1
)
